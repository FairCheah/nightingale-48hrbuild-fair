    ...
    <main className="min-h-screen bg-stone-50">
      <header className="border-b border-stone-200 bg-white">
        <div className="mx-auto max-w-2xl px-6 py-4 flex items-center justify-between">
          <div>
            <p className="font-semibold text-stone-900">Fairbloom</p>
            <p className="text-xs text-stone-500">Care team console</p>
          </div>
          <a href="/logout" className="text-sm text-stone-500 hover:text-stone-800">
            Sign out
          </a>
        </div>
      </header>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4">
          <div>
            ...
            <p className="mt-1.5 text-xs text-stone-400">
              Write it as you would say it. Avoid names, IC numbers, or anything identifying.
            </p>
          </div>
